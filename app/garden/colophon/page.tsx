...
// The site colophon — a concise, technical tour of how the site itself is
// built. The Garden's first post; listed in lib/garden.ts as `colophon`.
  ...
  return (
    <main>
      <PageHeader
        ...
        intro="The site itself, explained — the stack, the artwork, and the pipe that
        serves it."
      />
